...
export interface ApiAntidumpingverfahrenAntidumpingverfahren
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    betroffenesLand: Schema.Attribute.String;
    betroffeneWare: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiLandingpageWebinarLandingpageWebinar
  ...
  attributes: {
    ...
    >;
    conversionWebinarJamUrl: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiLandingpageLandingpage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    FAQSection: Schema.Attribute.Component<'shared.faq', false>;
    FinalUrl: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
